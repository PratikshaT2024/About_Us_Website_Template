  ...
  return (
    ...
    <div className='lg:justify-center lg:items-center  '>
      ...
      <div className="max-w-screen-xl  mt-0 bg-[#FEFFFB] flex flex-col lg:flex-row items-center justify-center lg:ml-32 ">
        ...
        <div className=" sm:w-1/2 p-5 text-start lg:text-right lg:justify-center" data-aos="zoom-in">
          <div className="">
        ...
        <div className="p-3 lg:w-1/2 mt-3 flex justify-center   lg:justify-center" data-aos="zoom-in">
          <div className="image text-center  lg:mr-20   ">
            <img className="h-[40vh] w-[40vh] lg:h-[80vh] lg:w-[90vh]  " src={img1}alt="Oncology" />
          </div>
        </div>
      </div>
    </div>
